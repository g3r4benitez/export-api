...
def gets(cd_resource: int, cd_instance: int):
    """Return business documents based on cd_resource and cd_instance"""

    celery_log.info(f"Running business documents tab for cd_resource={cd_resource} and cd_instance={cd_instance}")
    ...
    with conn:
        with conn.cursor() as cursor:
            ...
            query = Queries().get_business_documents(document_types)
